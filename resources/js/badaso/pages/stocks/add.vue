...
export default {
  ...
  methods: {
    submitForm() {
      ...
      //   })
      this.$openLoader();
      let amountOfStock = dataRows.amount_of_stock;
      this.$api.badasoEntity.read({
        slug: 'branches',
        id: dataRows.branch_id
      }).then((response) => {
        let data = response.data
        if (data.capacityLeft >= amountOfStock) {
          data.capacityLeft -= amountOfStock;
          ...
          this.$vs.notify({
            ...
            text: 'Jumlah stock melebihi kapasitas tersedia',
            color: "danger",
          });
        }
      })
    ...
    async getDataType() {
      ...
      try {
        ...
        // const response_branch = await this.$api.badasoEntity.browse({
        //   slug: 'branches'
        // });
        // let branches = response_branch.data.data;
        // let branches_capacity = {};
        // for(let branch of branches){
        //   branches_capacity[id] = branch.capacityLeft;
        // }
        // this.branches_capacity = branches_capacity
        // console.log(this.branches_capacity,'anjay')

...
export default {
  ...
  methods: {
    submitForm() {
      ...
      this.$openLoader();
      let amountOfTake = dataRows.amount_of_take;
      this.$api.badasoEntity.read({
        slug: 'takes',
        id: dataRows.id
      }).then((response)=>{
        let data = response.data
        this.takeAmount = data.amountOfTake
      })
      this.$api.badasoEntity.read({
        slug: 'stocks',
        ...
        result.amountOfStock += this.takeAmount
        if (result.amountOfStock >= amountOfTake) {
          result.amountOfStock -= amountOfTake;
            ...
            this.$api.badasoEntity
              .edit({
                ...
                id: result.branchId
                  ...
                  gudang.capacityLeft -= this.takeAmount
                  console.log(this.takeAmount, 'anjay')
                  gudang.capacityLeft += parseInt(amountOfTake);

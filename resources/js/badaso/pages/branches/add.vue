            ...
            <vs-row>
              ...
              >
                ...
                <template v-if="dataRow.add == 1">
                  ...
                  ></badaso-number>
                  <badaso-number
                    v-if="dataRow.type == 'number_hidden'"
                    :label="dataRow.displayName"
                    :placeholder="dataRow.displayName"
                    v-model="dataRow.value"
                    size="12"
                    :style="'visually-hidden:true'"
                    :alert="
                      errors[$caseConvert.stringSnakeToCamel(dataRow.field)]
                    "
                  ></badaso-number>
...
export default {
  ...
  methods: {
    submitForm() {
      ...
      // start request
      this.$openLoader();
      dataRows.capacity_left = 0;
      console.log(dataRows.capacity_left,"kapasitas tersedia awal")
      let capacity = dataRows.capacity;
      dataRows.capacity_left = capacity;
      console.log(dataRows.capacity_left,"kapasitas tersedia akhir")
    ...
    async getDataType() {
      ...
      try {
        ...
        const dataRows = response.data.crudData.dataRows.map((data) => {
          ...
          // if(data.field == "capacity-left"){
          //   data.type = "number_hidden",
          //   data.value = 0;
          // }

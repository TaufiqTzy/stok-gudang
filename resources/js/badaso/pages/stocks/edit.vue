  ...
  methods: {
    submitForm() {
      ...
      this.$api.badasoEntity.read({
        ...
        this.stockAmount = data.amountOfStock
      ...
      this.$api.badasoEntity.read({
        ...
        console.log(this.stockAmount);
        result.capacityLeft += this.stockAmount
        if (result.capacityLeft >= amountOfStock) {
          result.capacityLeft -= amountOfStock;
          console.log(result.capacityLeft)
